...
<div class="signup-form">
    <form action="/examples/actions/confirmation.php" method="post">
		...
		<div class="form-group">
            <input type="text" class="form-control" name="telp" id="telp" placeholder="Telp" required="required">
        </div>        
        <div class="form-group">
	...
	<div class="text-center">Sudah mempunyai akun? <a href="login.php">Masuk</a></div>
</div>
