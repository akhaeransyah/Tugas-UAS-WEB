            ...
            <div class="card-body">
                <form action="" method="POST" class="form-item">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="npm" class="form-control col-md-20" placeholder="Masukkan NPM Mahasiswa">
                    </div>

                    <div class="form-group">
                        <label for="nama">Nama Mahasiwa</label>
                        <input type="text" name="nama" class="form-control col-md-20" placeholder="Masukkan Nama Mahasiswa">
                    </div>

                    <div class="form-group">
                        <label for="tempat_lahir">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir" class="form-control col-md-20" placeholder="Masukkan Tempat Lahir Mahasiswa">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat" class="form-control col-md-20" placeholder="Masukkan Alamat Mahasiswa">
                    </div>

                    <div class="form-group">
                        <label for="kode_pos">Kode Pos</label>
                        <input type="number" name="kode_pos" class="form-control col-md-20" placeholder="Masukkan Kode Pos">
                    </div>
